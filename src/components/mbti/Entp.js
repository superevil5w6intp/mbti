    ...
    <Container>
      <details>
        ...
        <Contents>
          ...
          <p>
            MBTI에서 내향형(I)을 제외한 외향형(E) 타입들 중에서는 내성적인
            성향이 가장 큰 편이다. 타 외향형이 보기에 대인 교류에 그다지
            적극적이지 않은 ENTP유형이 드물지 않게 관찰되곤 한다. 따라서 교류가
            적은 지인들이 보기에는 내향형(I)으로 착각하는 경우가 많다.
          </p>
          ...
          <p>
            상담과 조언을 요구할 때에는 단순히 상대방의 의견이 궁금해서일
            뿐이다.
          </p>
          <p>평소 자신감이 넘치지만, 남에겐 자아도취로 보여지는 경우가 많다.</p>
          <p>
            때로는 3차기능인 Fe(외향감정)을 사용하여 친절한 모습과 협력적인
            모습을 보일수있으며 평균, 조화를 추구할수도 있다.
          </p>
          <p>넉살이 좋고 자기애가 강하다.</p>
