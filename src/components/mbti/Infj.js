  ...
  return (
    <Container>
      ...
      <Contents>
        ...
        <p>
          주기능이 Ni(내향 직관)으로 과거와 현재의 공통점을 찾아 미래를 예측하는
          것을 좋아하며 상상력, 창의력과 독창성이 뛰어나다. 때문에 비범한
          통찰력을 지녔다.
        </p>
        ...
        <p>
          이는 N 유형의 특징이기도 하다. 직관적 감성이 늘 현실을 초월하는 의미와
          관념에 관심을 기울이기 때문이다.
        </p>
        <p>
        ...
        <p>심리학에 관심이 많다.</p>
        <p>
          음악, 책 등의 예술 및 문학 분야에 많은 관심과 지식을 지니고 있으며, 그
          관심이 행동으로 직결되는 경우가 많기 때문에 그 분야에 뛰어난 감각을
          가지고 있는 사람이 많다.
        </p>
