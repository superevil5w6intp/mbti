  ...
  return (
    <Container>
      <details>
        ...
        <Contents>
          <p>
            근면성실하며 질서정연하고 효율, 상식, 논리를 중시하는 타입이기
            때문에 게으르거나, 일을 잘 못하거나, 뜬구름 잡는 몽상가적 소리를
            하거나, 잡생각이 많거나, 감정에 휘둘리거나, 충동적이거나, 목적
            의식이 없거나, 사회의 틀에 맞지 않게 행동하는 사람들을 싫어하고
            그러한 성격을 가진 가족이나 친구를 말로 공격할 수도 있다. 하지만
            젊어서 공격적인 성향을 가졌던 ESTJ도 점차 나이가 들고 완숙해지면
            결국 모든 사람들이 본인이 생각하는 가치관에 맞게 행동하지 않는다는
            사실을 알게 된다.
          </p>
          <p>
          ...
          <p>
            ...
            에너지는 쓰려고 하지 않는 편이기 때문에 분명한 외향형이지만
            내향형으로 보이는 경우가 있다.
          </p>
          <p>
          ...
          <p>
            ...
            성격이기 때문에 함께 지내다보면 맞춰서 리액션을 해주는 척을 하긴
            하나 굉장히 영혼이 없는 것이 티가 난다.
          </p>
          <p>
          ...
          <p>
            ...
            과업이나 자기계발을 행하는 데에 열중한다. 그러나 간혹 별것도 아닌
            일에 갑자기 감정이 격해지고 폭발할 때도 있다.
          </p>
        </Contents>
      </details>
      <Title>Estj 궁합 </Title>
