    ...
    <Container>
      <details>
        ...
        <Contents>
          ...
          <p>
            ENTJ가 지향하는 본인의 사회 역할은 생산적인 사람, 유능한 사람,
            영향력 있는 사람이다.
          </p>
          ...
          <p>대담한 도전정신이 있다.</p>
          <p>
            변화를 위한 계획을 명확히 세우고, 이를 이행하는 과정에서 매우
            단호하게 행동하는 편이다.
          </p>
          <p>
          ...
          <p>
            (토론·언쟁 속) 다방면에서 날아오는 공격으로부터 자신을 보호할 수
            있다.
          </p>
          ...
          <p>
            합리성을 따지지 않고 게으른 사람들을 파괴자로 인식하며, 저런
            사람들이 비효율의 원흉이라고 생각한다.
          </p>
          <p>생각이 객관적이고 명료하다.</p>
        </Contents>
      </details>
