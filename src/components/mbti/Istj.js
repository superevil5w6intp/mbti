  ...
  return (
    <Container>
      ...
      <Contents>
        ...
        <p>
          논리적, 합리적인 것을 중시하지만, 부기능이 Te(외향 사고)이고 주기능이
          Si(내향 감각)라서 구시대적인 관습을 논리에 따른 판단 없이 수용하는
          편이다.
        </p>
        <p>잘못했다는 건 인정하면서도 미안하다, 잘못했다고 잘 못한다.</p>
        <p>
          주기능이 Si(내향 감각)이면서 3차 기능이 Fi(내향 감정)이라서 사고형(T)
          중에서는 가장 감정(F) 성향이 높은 편이다. 그래서 자세히 관찰하지
          않으면 ISFJ와 혼동 할 수 있다.
        </p>
