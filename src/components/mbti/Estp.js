  ...
  return (
    <Container>
      ...
      <Contents>
        ...
        <p>
          주기능인 Se(외향 감각)과 부기능인 Ti(내향 사고)의 연상 작용으로 인하여
          모든 유형 중 감각적인 성향이 가장 강하다.
        </p>
        <p>
          ISTP와 더불어 창작물에서 Badass기믹으로 가장 빈번하게 나오는 성격 유형
          중 하나이다.
        </p>
        <p>무대의 중심에 서는 것과 관심을 즐긴다.</p>
        <p>
          타고난 해결사로써 문제를 해결하는 능력이 타의 추종을 불허한다. 그러나
          타고난 말썽꾸러기로써 문제를 유발하는 능력 또한 타의 추종을 불허한다.
        </p>
        <p>
        ...
        <p>
          ...
          뛰어나다. 다른 유형들은 미처 알아차리지 못하고 그냥 넘어갈 법한 타인의
          행동 변화나 옷차림의 변화, 또는 미세한 표정 변화 등을 곧 잘 포착하고
          이를 통해 상대방의 숨은 의도나 감정을 파악해내는 재주가 있으며
          사람이나 사물을 관찰할 때에는 선입견이나 편견을 씌우지 않고 있는
          그대로 바라보며 분석한다. 이와 같은 특성은 주로 이들의 내부에서
          이루어지기 때문에 대부분 겉으로는 잘 드러나지 않는다.
        </p>
        <p>
          미래지향적인 생각을 잘 하지 않고 현재지향적인 생각을 많이 한다. 언제나
          인생에서 현재, 바로 지금 이 찰나의 순간순간마다를 가장 중요한 시점으로
          여긴다.
        </p>
        <p>
        ...
        <p>
          xSxP 중에 수학 성적(학업성취도)이 안 좋은 사람들은 ‘학습목표를 장기와
          단기로 나누어 꾸준히 실천하는 전략’이 필요하다.
        </p>
